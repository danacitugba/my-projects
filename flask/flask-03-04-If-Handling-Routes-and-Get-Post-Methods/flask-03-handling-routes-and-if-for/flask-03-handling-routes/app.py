...
def home():
    ...
    # flask içinde html kodu kullanılabilir, h1 punto büyüklüğüdür
...
def about():
    ...
    # burada render_template yok, doğrudan hızlı yazdırma işlemi yapılıyor ve bu html dili ile yapılmaktadır. 
...
def admin():
    ...
    # biraz önceki error pathine redirect et, yönlendir demektir. admin pathini yazsak bile error sayfasına döner
